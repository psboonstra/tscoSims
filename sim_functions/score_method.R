...
# the oracle, estimated directly rather than through realized outcomes:
#
...
# taken over replicates. Summarize this column with the median and report how
...
score_method <- function(fit, p_true, alpha = 0.05, wt = NULL) {
  ...
  # the right shape and labeling; see valid_prob_matrix() in
