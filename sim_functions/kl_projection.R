...
#
# The first term does not involve theta, so minimizing KL is the same as
# maximizing the second term, the POPULATION expected log-likelihood. And the
...
#
# then a standard weighted fit maximizes precisely E_X[sum_k p_k log q_k].
#
...
# class. Minimizing RPS over the class would give a smaller number, and
...
# evaluated AT theta* rather than minimized in their own right (see the scoring
