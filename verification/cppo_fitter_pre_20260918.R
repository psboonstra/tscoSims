# The direct CPPO fitter as it stood before the 2026-09-18 rewrite (exp()-
# reparameterised spacings, BFGS, numerical gradients). Kept ONLY so that
# verification/r_cppo_fitter_check.R can compare against it. Not sourced by
# the simulation.
